...
class Robokassa {
    ...
    public static function factory($login = null, $password1 = null, $password2 = null, $production = null)
    {
        return new Robokassa($login, $password1, $password2, $production);
    }

    function __construct($login = null, $password1 = null, $password2 = null, $production = null)
    {
        $this->login = $login;
...
//					'IncCurrLabel'=>$currency,
        ...
        $host_use = ($this->production) ? $host : $host_test;
        $link = $host_use.URL::query($query);
        return $link;
    }
